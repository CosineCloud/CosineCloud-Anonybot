...
def listfiles(path):
    try:
        folder_path = str("/code/Python_Lab/Anonychat/"+str(path))
...
def Blocklistadd(A,B,C):
    df = pd.read_csv('/code/Python_Lab/Anonychat/Blocklist.csv')
    ...
    if x == "":
        ...
        s = df.append(df1)
        s2 = s.to_csv(r'/code/Python_Lab/Anonychat/Blocklist.csv', index=False)
...
def chtrecord(nm,mid,msg,reqmid):
    msg1 = msg.replace("\n", " ")
    with open('/code/Python_Lab/Anonychat/AI_chatlogs/'+str(reqmid)+'_logs.txt', 'a') as f:
...
def QRCode(link,mID):
    try:
        os.remove('/code/Python_Lab/Anonychat/temp/qrcode'+str(mID)+'.png')
    except:
        print('no QRcode')
    img = qrcode.make(link)
    img.save('/code/Python_Lab/Anonychat/temp/qrcode'+str(mID)+'.png')
    return 'qrcode done'
                        ...
                        if int(D2b) <= 0 :
                            ...
                            try:
                                ...
                                if E1b == 'private':
                                    ...
                                    bot.send_photo(str(D1b), photo=open('temp/img/'+str(message.chat.id)+'_photo.jpg', 'rb'))
                                    os.remove('temp/img/'+str(message.chat.id)+'_photo.jpg')
                                    leasing(int(message.chat.id),1200)
                                    anych_para_modify('BAL',(lookup('MID','BAL',message.chat.id))-2.5,message.chat.id)
                                    anych_para_modify('MSGOUT',int(lookup('MID','MSGOUT',message.chat.id))+1,message.chat.id)
                                    anych_para_modify('MSGIN',int(lookup('MID','MSGIN',int(D1b)))+1,int(D1b))
                                    msgpic = bot.send_message(message.chat.id, '✅ 𝗣𝗶𝗰𝘁𝘂𝗿𝗲 𝘀𝗲𝗻𝘁 !!')
...
def start(message):
    if str(message.text) == '/start':
        ...
        if str(b) == 'None':
            ...
            if str(a) == 'not found':
                if (os.stat("/code/Python_Lab/Anonychat/notice.txt").st_size == 0) :
                            return 0
                else:
                    time.sleep(0)
                    with open('/code/Python_Lab/Anonychat/notice.txt') as f:
                        f = f.read()
                    bot.send_chat_action(str(message.chat.id), 'typing')
                ...
                bot.send_chat_action(str(message.chat.id), 'typing')
                #with open('/code/Python_Lab/Anonychat/anonymouschats_message01.ogg', 'rb') as audio:
            ...
            if str(message.chat.id) == '584429967':
                ...
                keyboard.add(button_g,button_h)
                keyboard.add(button_j)
            #bot.send_photo(message.chat.id, photo=open('/code/Python_Lab/Anonychat/Anonychat_banner.jpg', 'rb'),caption= ".            𝔄 𝔫 𝔬 𝔫 𝔶 𝔪 𝔬 𝔲 𝔰    ℭ 𝔥 𝔞 𝔱 𝔰", reply_markup=keyboard)
            ...
            def callback_inline(call):
                                            ...
                                            def callback_inline(call):
                                                if call.data == 'link_yes':
                                                    ...
                                                    if str(D1b) == '-invalid-':
                                                        ...
                                                        mID = str(call.from_user.id)
                                                        if QRCode(QRL,mID) == 'qrcode done':
                                                            msgpvt = bot.send_photo(D1c, photo=open('/code/Python_Lab/Anonychat/temp/qrcode'+str(mID)+'.png', 'rb'),caption= '𝗬𝗼𝘂𝗿 𝗽𝗮𝗿𝘁𝗻𝗲𝗿 𝘄𝗮𝗻𝘁𝘀 𝘁𝗼 𝗰𝗼𝗻𝗻𝗲𝗰𝘁 𝘄𝗶𝘁𝗵 𝘆𝗼𝘂 𝗮𝘀 𝗽𝗿𝗶𝘃𝗮𝘁𝗲 𝘀𝘁𝗮𝘁𝘂𝘀 !! 𝗣𝗹𝗲𝗮𝘀𝗲 𝗰𝗹𝗶𝗰𝗸 𝗼𝗻 𝘁𝗵𝗲 𝗯𝗲𝗹𝗼𝘄 𝗹𝗶𝗻𝗸 𝗼𝗿 𝘁𝘆𝗽𝗲 𝗶𝗻 𝗰𝗵𝗮𝘁 𝗯𝗼𝘅 𝗼𝗿 𝗿𝗲𝘀𝗲𝗻𝗱 𝘁𝗵𝗲 𝗤𝗥 𝗰𝗼𝗱𝗲 𝗶𝗻 𝗮𝗻𝗼𝗻𝘆𝗺𝗼𝘂𝘀 𝗰𝗵𝗮𝘁 𝘁𝗼 𝗰𝗵𝗮𝗻𝗴𝗲 𝘆𝗼𝘂𝗿 𝗰𝗼𝗻𝗻𝗲𝗰𝘁𝗶𝗼𝗻 𝘀𝘁𝗮𝘁𝘂𝘀 : \n\n/pvt'+str(xcode)+str(D)+str(xcode2)+str(D1b)+"\n\n\n𝗡𝗢𝗧𝗘: 𝗘𝘀𝘁𝗮𝗯𝗹𝗶𝘀𝗵𝗶𝗻𝗴 𝗮 𝗽𝗿𝗶𝘃𝗮𝘁𝗲 𝗰𝗼𝗻𝗻𝗲𝗰𝘁𝗶𝗼𝗻 𝘄𝗶𝗹𝗹 𝗻𝗼𝘁 𝗰𝗼𝗺𝗽𝗿𝗼𝗺𝗶𝘀𝗲 𝘆𝗼𝘂𝗿 𝗮𝗻𝗼𝗻𝘆𝗺𝗶𝘁𝘆, 𝗯𝘂𝘁 𝗶𝘁 𝘄𝗶𝗹𝗹 𝗲𝗻𝘀𝘂𝗿𝗲 𝗮 𝘀𝗲𝗰𝘂𝗿𝗲 𝗰𝗼𝗻𝗻𝗲𝗰𝘁𝗶𝗼𝗻 𝘄𝗶𝘁𝗵 𝘆𝗼𝘂𝗿 𝗽𝗿𝗶𝘃𝗮𝘁𝗲 𝗽𝗮𝗿𝘁𝗻𝗲𝗿 𝗮𝗻𝗱 𝗽𝗿𝗲𝘃𝗲𝗻𝘁 𝗮𝗻𝘆 𝗸𝗶𝗻𝗱 𝗼𝗳 𝗱𝗶𝘀𝗰𝗼𝗻𝗻𝗲𝗰𝘁𝗶𝗼𝗻𝘀.")
                                                            os.remove('/code/Python_Lab/Anonychat/temp/qrcode'+str(mID)+'.png')
                                                        #msgpvt = bot.send_message(call.from_user.id, '𝚈𝚘𝚞𝚛 𝙸𝙳 𝚁𝚎𝚊𝚍𝚢 𝚏𝚘𝚛 𝚙𝚛𝚒𝚟𝚊𝚝𝚎 𝚌𝚘𝚗𝚗𝚎𝚌𝚝𝚒𝚘𝚗 : \n\n/pvt'+str(xcode)+str(D)+str(xcode2)+str(D1b)+"\n\n\n𝚈𝚘𝚞𝚛 𝚙𝚛𝚒𝚟𝚊𝚝𝚎 𝚌𝚘𝚗𝚗𝚎𝚌𝚝𝚒𝚘𝚗 𝚕𝚒𝚗𝚔 𝚠𝚒𝚕𝚕 𝚎𝚡𝚙𝚒𝚛𝚎 𝚒𝚗 𝟼𝟶𝚜𝚎𝚌.")
                                                    D2a = finder('ID',int(str(call.from_user.id)))
                                                    D2b = get((D1a),'Status')
                        ...
                        if str(checkdb) == "error" or str(checkdb) == "Random Connection Service is currently under maintenance\n\nPlease Try Later \nor\nUse Other Services" or str(checkdb) == "Random Connection Manager is unresponsive\n\nPlease Try Later or Use Other Services ":
                            ...
                            if str(MA1a) == 'not found':
                                ...
                                if (L) < 1 :
                                    ...
                                    anych_modify('tout',1200,int(str(call.from_user.id)))
                                    anych_modify('OTP',0,int(str(call.from_user.id)))
                                    ...
                                    try:
                                        ...
                                        if D == 'unregistered':
                                            ...
                                            anych_modify('Status','waiting',int(str(call.from_user.id)))
                                            leasing(int(call.from_user.id),1200)
                            ...
                            try:
                                ...
                                if str(D1b) == '-invalid-':
                                    ...
                                    if QRCode(QRL,(str(D1b)+str(mID))) == 'qrcode done':
                                        msgpvt = bot.send_photo(call.from_user.id, photo=open('/code/Python_Lab/Anonychat/temp/qrcode'+str(D1b)+str(mID)+'.png', 'rb'),caption= '𝚈𝚘𝚞𝚛 𝙸𝙳 𝚁𝚎𝚊𝚍𝚢 𝚏𝚘𝚛 𝚙𝚎𝚛𝚖𝚊𝚗𝚎𝚗𝚝 (𝟷 𝚍𝚊𝚢 𝚙𝚊𝚜𝚜) 𝚌𝚘𝚗𝚗𝚎𝚌𝚝𝚒𝚘𝚗 : \n\n/brc'+str(xcode)+str(D1b)+str(mID)+str(xcode2)+"\n\n\n𝙽͟𝙾͟𝚃͟𝙴͟: 𝚂𝚎𝚗𝚍 𝚝𝚑𝚎 𝚊𝚋𝚘𝚟𝚎 𝚕𝚒𝚗𝚔 𝚘𝚛 𝚀𝚁 𝚌𝚘𝚍𝚎 𝚘𝚛 𝚙𝚎𝚎𝚛 𝚊𝚕𝚜𝚘 𝚌𝚊𝚗 𝚞𝚜𝚎 𝚌𝚊𝚖𝚎𝚛𝚊 𝚝𝚘 𝚜𝚌𝚊𝚗 𝚒𝚝 𝚊𝚗𝚍 𝚜𝚎𝚗𝚍 𝚝𝚘 𝚑𝚒𝚜/𝚑𝚎𝚛  '𝙰𝚗𝚘𝚗𝚢𝚖𝚘𝚞𝚜 𝙲𝚑𝚊𝚝' 𝚝𝚘 𝚎𝚜𝚝𝚊𝚋𝚕𝚒𝚜𝚑 𝚝𝚑𝚎 𝚌𝚘𝚗𝚗𝚎𝚌𝚝𝚒𝚘𝚗\n\n\n(𝚈𝚘𝚞𝚛 𝚙𝚎𝚛𝚖𝚊𝚗𝚎𝚗𝚝 (𝟷 𝚍𝚊𝚢 𝚙𝚊𝚜𝚜) 𝚌𝚘𝚗𝚗𝚎𝚌𝚝𝚒𝚘𝚗 𝚕𝚒𝚗𝚔 𝚠𝚒𝚕𝚕 𝚎𝚡𝚙𝚒𝚛𝚎 𝚒𝚗 𝟼𝟶𝚜𝚎𝚌.")
                                        os.remove('/code/Python_Lab/Anonychat/temp/qrcode'+str(D1b)+str(mID)+'.png')
                                        with open('/code/Python_Lab/Anonychat/Broadcasting/Broadcasting_'+str(D1b)+str(mID)+'.txt', "w") as f:
                                            f.write("")
                                    #msgpvt = bot.send_message(call.from_user.id, '𝚈𝚘𝚞𝚛 𝙸𝙳 𝚁𝚎𝚊𝚍𝚢 𝚏𝚘𝚛 𝚙𝚛𝚒𝚟𝚊𝚝𝚎 𝚌𝚘𝚗𝚗𝚎𝚌𝚝𝚒𝚘𝚗 : \n\n/pvt'+str(xcode)+str(D)+str(xcode2)+str(D1b)+"\n\n\n𝚈𝚘𝚞𝚛 𝚙𝚛𝚒𝚟𝚊𝚝𝚎 𝚌𝚘𝚗𝚗𝚎𝚌𝚝𝚒𝚘𝚗 𝚕𝚒𝚗𝚔 𝚠𝚒𝚕𝚕 𝚎𝚡𝚙𝚒𝚛𝚎 𝚒𝚗 𝟼𝟶𝚜𝚎𝚌.")
                                D2a = finder('ID',int(str(call.from_user.id)))
                                D2b = get((D1a),'Status')
                ...
                #================================================
                    ...
                    with open('/code/Python_Lab/Anonychat/about.txt') as f:
                            privacy = f.read()
                ...
                #================================================
                    ...
                    peer_status = get((A1a),'Status')
                    anych_modify('Status','paused',int(str(call.from_user.id)))
                    with open('/code/Python_Lab/Anonychat/privacystatement.txt') as f:
                            privacy = f.read()
                    msghelp = bot.send_message(call.message.chat.id, str(privacy))
                    anych_modify('Status',str(peer_status),int(str(call.from_user.id)))
                #================================================
                ...
                #================================================
                    ...
                    def callback_inline(call):
                        if call.data == 'IDC_yes':
                            ...
                            if A0b == "subscriber":
                                msgcl1a = bot.send_message(str(call.from_user.id),broadcast_subcancel('/code/Python_Lab/Anonychat/Broadcasting/brc'+str(A0c),int(call.from_user.id)))
                                time.sleep(6)
                ...
                #================================================
                    ...
                    #bot.edit_message_photo(chat_id=call.message.chat.id, message_id=call.message.message_id, photo=open('/code/Python_Lab/Anonychat/Anonychat_banner.jpg', 'rb'),caption= ".            𝔄 𝔫 𝔬 𝔫 𝔶 𝔪 𝔬 𝔲 𝔰    ℭ 𝔥 𝔞 𝔱 𝔰", reply_markup=keyboard)
            ...
            def callback_inline(call):
                ...
                #================================================
                    ...
                    peer_status = get((A1a),'Status')
                    anych_modify('Status','paused',int(str(call.from_user.id)))
                    with open('/code/Python_Lab/Anonychat/help.txt') as f:
                            f = f.read()
                    anych_modify('Status',str(peer_status),int(str(call.from_user.id)))
                ...
                #================================================
                    ...
                    with open('/code/Python_Lab/Anonychat/contactus.txt') as f:
                            f = f.read()
                    msghelp = bot.send_message(call.message.chat.id, str(f))
        ...
        a = (broadcast('/code/Python_Lab/Anonychat/Broadcasting/test.txt'))
    elif str(message.text) == '/test01':
        try:
            print(SignalWrite((message.chat.id),0,1))
        except Exception as e:
        ...
        while b <= a :
            ...
            #broadcastIDs('/code/Python_Lab/Anonychat/Broadcasting/test.txt',b-1)
            if b == a:
                bot.send_message('584429967','Subscriber no '+str(b)+' is :'+str(broadcastIDs('/code/Python_Lab/Anonychat/Broadcasting/test.txt',b)))
        ...
        if str(message.chat.id) == '584429967':
            ...
            for i in range(num_ids):
                try:
                    ...
                    df.to_csv('/code/Python_Lab/Anonychat/Anonychatdb01.2.csv', index=False)
        ...
        if D == "-":
            ...
            try:
                broadcastlist = "/code/Python_Lab/Anonychat/Broadcasting/Broadcasting_"+str(D)+str(D1)+".txt"
            ...
            if str(D1) == str(message.chat.id):
                ...
                if D2 == 'OK':
                    ...
                    anych_modify('tout',1200,int(str(message.chat.id)))
        ...
        if D == "-":
            ...
            if str(D1) == str(A1b):
                ...
                if D2 == 'OK':
                    ...
                    #print('Peer 1 done')
                    anych_modify('tout',1200,int(C1b))
            ...
            if str(D1d) == '-':
                ...
                try:
                    ...
                    while b <= a :
                        ...
                        #broadcastIDs('/code/Python_Lab/Anonychat/Broadcasting/test.txt',b-1)
                        if b == a:
                            bot.send_message(str(broadcastIDs('/code/Python_Lab/Anonychat/Broadcasting/test.txt',b)),str(message.text))
                ...
                if VDOchk == 0:
                    ...
                    if int(D2b) == 'yo =0':
                        ...
                        leasing(int(message.chat.id),1200)
                        with open('/code/Python_Lab/Anonychat/chat_recorder.txt', 'a') as f:
